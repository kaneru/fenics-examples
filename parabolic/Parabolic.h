...
#ifndef __PARABOLIC_H
#define __PARABOLIC_H
...
class parabolic_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  parabolic_finite_element_0();

  /// Destructor
  virtual ~parabolic_finite_element_0();
...
class parabolic_finite_element_1: public ufc::finite_element
{
public:

  /// Constructor
  parabolic_finite_element_1();

  /// Destructor
  virtual ~parabolic_finite_element_1();
...
class parabolic_dofmap_0: public ufc::dofmap
{
public:
...
class parabolic_dofmap_1: public ufc::dofmap
{
public:
...
class parabolic_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  parabolic_cell_integral_0_otherwise();

  /// Destructor
  virtual ~parabolic_cell_integral_0_otherwise();
...
class parabolic_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  parabolic_cell_integral_1_otherwise();

  /// Destructor
  virtual ~parabolic_cell_integral_1_otherwise();
...
class parabolic_form_0: public ufc::form
{
public:
...
class parabolic_form_1: public ufc::form
{
public:
...
public:
  ...
  CoefficientSpace_dt(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new parabolic_finite_element_0()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dofmap>(new parabolic_dofmap_0()), mesh)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_dt(boost::shared_ptr<const dolfin::Mesh> mesh, boost::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new parabolic_finite_element_0()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dofmap>(new parabolic_dofmap_0()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_dt(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new parabolic_finite_element_0()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dofmap>(new parabolic_dofmap_0()),
...
public:
  ...
  CoefficientSpace_f(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new parabolic_finite_element_1()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dofmap>(new parabolic_dofmap_1()), mesh)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(boost::shared_ptr<const dolfin::Mesh> mesh, boost::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new parabolic_finite_element_1()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dofmap>(new parabolic_dofmap_1()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new parabolic_finite_element_1()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dofmap>(new parabolic_dofmap_1()),
                                                                                     reference_to_no_delete_pointer(restriction))))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 1), dt(*this, 0)
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new parabolic_form_0());
  }
  ...
  // Constructor
  Form_a(const dolfin::FunctionSpace& V1, const dolfin::FunctionSpace& V0, boost::shared_ptr<const dolfin::GenericFunction> dt):
    dolfin::Form(2, 1), dt(*this, 0)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
    _function_spaces[1] = reference_to_no_delete_pointer(V1);
  ...
  // Constructor
  Form_a(boost::shared_ptr<const dolfin::FunctionSpace> V1, boost::shared_ptr<const dolfin::FunctionSpace> V0, const dolfin::GenericFunction& dt):
    dolfin::Form(2, 1), dt(*this, 0)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;
  ...
  // Constructor
  Form_a(boost::shared_ptr<const dolfin::FunctionSpace> V1, boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::GenericFunction> dt):
    dolfin::Form(2, 1), dt(*this, 0)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;
...
public:
    ...
    dolfin::Form(1, 3), u0(*this, 0), f(*this, 1), dt(*this, 2)
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new parabolic_form_1());
  }

  // Constructor
  Form_L(const dolfin::FunctionSpace& V0, const dolfin::GenericFunction& u0, const dolfin::GenericFunction& f, const dolfin::GenericFunction& dt):
    dolfin::Form(1, 3), u0(*this, 0), f(*this, 1), dt(*this, 2)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  // Constructor
  Form_L(const dolfin::FunctionSpace& V0, boost::shared_ptr<const dolfin::GenericFunction> u0, boost::shared_ptr<const dolfin::GenericFunction> f, boost::shared_ptr<const dolfin::GenericFunction> dt):
    dolfin::Form(1, 3), u0(*this, 0), f(*this, 1), dt(*this, 2)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  // Constructor
  Form_L(boost::shared_ptr<const dolfin::FunctionSpace> V0, const dolfin::GenericFunction& u0, const dolfin::GenericFunction& f, const dolfin::GenericFunction& dt):
    dolfin::Form(1, 3), u0(*this, 0), f(*this, 1), dt(*this, 2)
  {
    _function_spaces[0] = V0;
  ...
  // Constructor
  Form_L(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::GenericFunction> u0, boost::shared_ptr<const dolfin::GenericFunction> f, boost::shared_ptr<const dolfin::GenericFunction> dt):
    dolfin::Form(1, 3), u0(*this, 0), f(*this, 1), dt(*this, 2)
  {
    _function_spaces[0] = V0;
